  ...
  return (
    <div className="flex flex-col gap-y-50">
      {plannedPlaces.map(({ place, startTime, endTime }) => (
        <div className="flex w-[253px] pl-29 relative before:absolute before:left-10 before:block before:bg-gray200 before:w-1 before:h-69 before:top-35 last:before:h-0">
